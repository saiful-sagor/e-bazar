...
const Navbar = () => {
  return (
    ...
    <nav className="fixed top-0 left-0 z-50 w-full text-white bg-white shadow">

  <div className="container mx-auto px-6 py-3 md:flex md:justify-between md:items-center">
    <div className="flex justify-between items-center">
      <div>
        <Link className="text-gray-800 text-xl font-bold md:text-2xl hover:text-gray-700" to="/">e-Bazar</Link>
      </div>
